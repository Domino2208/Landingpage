...
def sende_bestaetigung_email(gast, qr_code_base64):
    try:
        ...
        <body>
            ...
            <p>Alternativ können Sie auch diesen Link verwenden:</p>
            <p><a href="{request.url_root}checkin/{gast.unique_code}">Check-in Link</a></p>
...
if __name__ == '__main__':
    ...
    app.run(debug=True, host='192.168.2.225', port=5000)